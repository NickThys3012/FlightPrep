...
public class LiftCalculatorTests
{
    ...
    public void Calculate_AEqualsEg_AmbientTempEqualsGroundTemp()
    {
        ...
        var result = LiftCalculator.Calculate(50, 50, tg, 80, 2200);
    ...
    {
        // Arrange
        var result = LiftCalculator.Calculate(1000, 20, 15, 80, 0);
    ...
    public void Calculate_HigherAltitude_LowerLift()
    {
        ...
        var low = LiftCalculator.Calculate(500, 20, 15, 80, 2200);
        var high = LiftCalculator.Calculate(2000, 20, 15, 80, 2200);
    ...
    {
        // Arrange
        var cool = LiftCalculator.Calculate(1000, 20, 15, 60, 2200);
        var hot = LiftCalculator.Calculate(1000, 20, 15, 90, 2200);
    ...
    public void Calculate_NegativeLift_WhenTiLessThanAmbient_DoesNotThrow()
    {
        ...
        var result = LiftCalculator.Calculate(1000, 20, 15, 5, 2200);
    ...
    public void Calculate_LargeVolume_ScalesLinearly()
    {
        ...
        var half = LiftCalculator.Calculate(1000, 20, 15, 80, 1100);
        var single = LiftCalculator.Calculate(1000, 20, 15, 80, 2200);
        var dbl = LiftCalculator.Calculate(1000, 20, 15, 80, 4400);
    ...
    public void Calculate_TiAt0_DoesNotThrow()
    {
        ...
        var exception = Record.Exception(() => LiftCalculator.Calculate(1000, 20, 15, 0, 2200));
