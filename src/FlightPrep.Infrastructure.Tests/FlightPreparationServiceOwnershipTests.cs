...
public class FlightPreparationServiceOwnershipTests
{
        ...
        SeedOwnershipFlightsAsync(IDbContextFactory<AppDbContext> factory)
    {
        ...
        var fp1 = new FlightPreparation
        {
            Datum           = new DateOnly(2025, 1, 1),
            Tijdstip        = TimeOnly.MinValue,
            CreatedByUserId = "user1"
        };
        var fp2 = new FlightPreparation
        {
            Datum           = new DateOnly(2025, 2, 1),
            Tijdstip        = TimeOnly.MinValue,
            CreatedByUserId = "user2"
        };
        var fp3 = new FlightPreparation
        {
            Datum           = new DateOnly(2025, 3, 1),
            Tijdstip        = TimeOnly.MinValue,
    ...
    public async Task GetSummariesAsync_AdminUser_ReturnsAllFlights()
    {
        ...
        // Act
        var result = await sut.GetSummariesAsync(userId: "user1", isAdmin: true);
    ...
    public async Task GetAllWithNavAsync_AdminUser_ReturnsAllFlights()
    {
        ...
        // Act
        var result = await sut.GetAllWithNavAsync(userId: "admin", isAdmin: true);
