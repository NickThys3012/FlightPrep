...
public class WeatherFetchServiceTests
{
    ...
    private static readonly DateTime PastWindowStart = new(2024, 1, 15, 6, 0, 0, DateTimeKind.Utc);
    // ── helpers ──────────────────────────────────────────────────────────────
    ...
    public async Task FetchWindProfileAsync_HttpThrows_ReturnsEmpty()
    {
        ...
        // Assert – exception must not propagate; service returns an empty list
        Assert.Empty(result);
    }
